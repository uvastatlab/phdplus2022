...
3.  Save the file (Ctrl + S or Cmd + S) as "alb_homes_report". **Save the file in the folder created when you unzipped the workshop files, which should be called `using_rmarkdown`.** (In other words, save it where the "refs.bib" file is located.)
4.  click Knit.
